...
const ImageModal: FC<ImageModalProps> = ({ images, currentIndex, onClose, onNavigate }) => {
    ...
    const isInvalid = !images || images.length === 0 || typeof currentIndex !== 'number' || !images[currentIndex];
